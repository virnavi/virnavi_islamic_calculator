...
SunTimeTable _$SunTimeTableFromJson(Map<String, dynamic> json) => SunTimeTable(
  ...
  sunrise: DateTimeHelper.fromRangeJson(
    json['sunrise'] as Map<String, dynamic>,
  ),
  sunset: DateTimeHelper.fromRangeJson(json['sunset'] as Map<String, dynamic>),
  dawn: DateTimeHelper.fromJson((json['dawn'] as num).toInt()),
  dusk: DateTimeHelper.fromJson((json['dusk'] as num).toInt()),
  nauticalDawn: DateTimeHelper.fromJson((json['nauticalDawn'] as num).toInt()),
  nauticalDusk: DateTimeHelper.fromJson((json['nauticalDusk'] as num).toInt()),
  ...
  goldenHourStart: DateTimeHelper.fromJson(
    (json['goldenHourStart'] as num).toInt(),
  ),
  goldenHourEnd: DateTimeHelper.fromJson(
    (json['goldenHourEnd'] as num).toInt(),
  ),
);
